...
run_config = {
    ...
    "variant": "augmented_stable", "epochs": EPOCHS, "batch_size": BATCH_SIZE,
...
ckpt_name = f"fullmodel_augmented_stable_{USE}_dim{LATENT_DIM}_ep{EPOCHS}.pt"
torch.save({
