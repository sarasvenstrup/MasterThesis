...
% ── Opening motivation (why simulation-based pricing?) ──────────────────────
\input{ThesisLayout/mainmatter/PricingMotivation}
% ────────────────────────────────────────────────────────────────────────────

The remainder of this chapter develops the technical framework.
Section~\ref{sec:swaption_pricing_methodology} describes the general Monte Carlo swaption pricing methodology.
Section~\ref{sec:bachelier_model} describes the Bachelier normal
...
Finally, the Monte Carlo price is converted into a model-implied normal volatility using the Bachelier swaption formula (described in the next section). The model-implied normal volatility is obtained by numerically inverting the Bachelier formula so that the analytical price matches the Monte Carlo estimate $\widehat V_0$.
