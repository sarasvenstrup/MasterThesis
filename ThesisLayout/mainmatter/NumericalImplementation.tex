% Note: the stable parameterisations of K, H, and R are described
% in Stable.tex (Chapter: Towards a Stable Autoencoder).
% NumericalImplementation.tex covers only the baseline model's
% forward pass, arbitrage diagnostics, estimation objective, and
