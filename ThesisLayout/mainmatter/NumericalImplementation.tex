...
\textcolor{red}{Synes argumentationen skal være baseret på det teoretiske ved at K og H skal opfylde nogle constraints for at der overhovedet findes en unik løsning til vores SDE og det er derfor at vi indfører disse K, H og R. Og ikke at vi ser at den er numerisk ustabil. Synes det er meget fint at vi i forlængelse af Rolfs K, H og R introducere vores versioner. Og så kan vi så senere hen sige hvad vi ser ske i resultsat afsnittet. Tror også jeg er en smue forvirret over hvorfor vi stabilisere R på den måde, troede ikke den skulle stabilisers for den skal opfylde den hard constraint Rolf snakker og det mener jeg ikke den gør med}
