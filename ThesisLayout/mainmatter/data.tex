...
\begin{figure}[htbp]
    ...
    \caption{Time series of the 10-year swap rate for each currency. Circles mark the
        first and last observation for each currency. Vertical dashed lines indicate
        four key macro events: the Global Financial Crisis (15 Sep 2008),
