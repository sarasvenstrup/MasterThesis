...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{Figures/Q4b_per_currency_bar_chart_dim2.png}
        \caption{$\ell = 2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{Figures/Q4b_per_currency_bar_chart_dim3.png}
        \caption{$\ell = 3$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{Figures/Q4b_per_currency_bar_chart_dim4.png}
        \caption{$\ell = 4$}
    \end{subfigure}
    \caption{OOS RMSE per currency for the autoencoder (AE) and EKF DNS benchmark across latent dimensions $\ell = 2, 3, 4$. Dashed horizontal lines indicate the cross-currency average for each model.}
    \label{fig:Q4b_per_currency}
\end{figure}
