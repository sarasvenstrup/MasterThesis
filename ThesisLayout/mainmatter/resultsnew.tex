...
\begin{figure}[htbp]
    ...
    \caption{Pearson correlation between each latent factor $z_k$ and the level, slope,
    and curvature of the swap curve, for $\ell \in \{2, 3, 4\}$.
    Blue indicates positive correlation, red indicates negative correlation.
    Correlations are computed on the in-sample training observations with 2500 epochs.}
