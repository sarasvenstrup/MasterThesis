...
\begin{table}[htbp]
\centering
\caption{In-sample RMSE (bps) per currency and latent dimension $\ell$, evaluated on the
full training set after 5\,000 epochs.}
\label{tab:q1a_is_rmse}
\resizebox{\textwidth}{!}{%
\pgfplotstabletypeset[
    string type,
    columns/[index 0]/.style={column name={$\ell$}},
]{Figures/thesis_results/AutoencoderPerformance/Q1a_IS_rmse_all_dims.csv}%
}
\end{table}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{Figures/thesis_results/AutoencoderPerformance/Q1b_fitted_vs_actual.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/thesis_results/AutoencoderPerformance/Q1c_residual_histogram.png}
