...
$\ell \in \{2, 3, 4\}$. \textcolor{red}{[Fill in: describe the shape,
e.g.\ ``The residuals are approximately symmetric around zero across
all dimensions, with the distribution tightening from $\ell=2$ to
$\ell=4$.'']}
