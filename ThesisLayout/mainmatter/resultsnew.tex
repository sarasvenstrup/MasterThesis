...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Figures/thesis_results/AutoencoderPerformance/Q1b_fitted_vs_actual.png}
    \caption{Fitted vs.\ actual swap curves for three representative dates
    (low-rate, high-rate, inverted) using the autoencoder with $\ell=3$.}
    \label{fig:Q1b}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Distribution of in-sample residuals (fitted $-$ actual, in bps)
    across all currencies and dates, $\ell=3$.}
    \label{fig:Q1c}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Figures/thesis_results/AutoencoderPerformance/Q1d_fitted_vs_actual_all_dims.png}
    \caption{Fitted vs.\ actual swap curves for the same representative dates
    across latent dimensions $\ell=2,3,4$.}
    \label{fig:Q1d}
\end{figure}
