...
% ======================
\node[neuron, fill=grey!40] (S1)  at (0,  2.5) {$S_{1}$};
\node[neuron, fill=grey!40] (S2)  at (0,  1.0) {$S_{2}$};
\node at (0, -0.2) {$\vdots$};
\node[neuron, fill=grey!40] (SM)  at (0, -2.2) {$S_{M}$};
...
\node at (16, -0.2) {$\vdots$};
\node[neuron, fill=grey!10] (StM) at (16, -2.2) {$\tilde{S}_{M}$};

% ======================
% Connections
% ======================
\foreach \s in {S1,S2,SM} {
    \draw[->, draw=darkgrey] (\s) -- (Z1);
    \draw[->, draw=darkgrey] (\s) -- (Zd);
}
...
\draw[->, draw=darkgrey] (P1)  -- (StM);
\draw[->, draw=darkgrey] (P2)  -- (StM);
\draw[->, draw=darkgrey] (P30) -- (StM);
