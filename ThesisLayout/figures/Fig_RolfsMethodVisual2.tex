...
$\mathcal{G}$ has $h_1,\ldots,h_{10}$, while $\mathcal{H}$ and $\mathcal{R}$
have $h_1,\ldots,h_4$. The output $\mathcal{K}(z)$ is connected directly to the latent
factors without a hidden layer. Only $\mathcal{G}(z,\tau)$ additionally depends on the maturity $\tau$.}
