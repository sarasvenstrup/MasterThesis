...
\draw[->, draw=darkgray] (CX1) -- node[above, sloped, font=\scriptsize] {$w_{h,j1}$} (CN);
\draw[->, draw=darkgray] (CX2) -- node[above, font=\scriptsize]         {$w_{h,j2}$} (CN);
\draw[->, draw=darkgray] (CXM) -- node[below, sloped, font=\scriptsize] {$w_{h,jM_{h-1}}$} (CN);
